...
io.on("connection", (socket) => {
  ...
  socket.on("sendIceCandidateToSignallingServer", (iceCandidateObj) => {
      ...
      if (offerInOffers) {
        ...
        if (offerInOffers.answererUserName) {
          ...
          if (socketToSendTo) {
            socket
              .to(socketToSendTo)
              .emit("receiveIceCandidateFromServer", iceCandidate);
          } else {
            console.log(
              "Ice candidate received but could not find the answered"
            );
          }
        }
      } else {
